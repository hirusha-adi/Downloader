...
def ENTIRE_PROGRAM():
        ...
        if mmo == "1":
                ...
                DOWNLOAD_VIDEO(qualityvid=selectquality, urlvid=downloadlink, subs=psubs, videoinformationyn=pvideoinformationyn)
        ...
        if mmo == "2":
                ...
                if allorsome.lower() in no_wl:
                        ...
                        for url in pl.video_urls[:whatno2dl]:
                                DOWNLOAD_VIDEO(qualityvid=selectquality, urlvid=url, subs=psubs, videoinformationyn=pvideoinformationyn)
...
Video Link: {video_link}
                ...
                if download_type == "video":
                        DOWNLOAD_VIDEO(qualityvid=selectquality, urlvid=video_link, subs=psubs, videoinformationyn=pvideoinformationyn)
